These are simple Vagrant files that are being used to produce the packages for Riak. Please feel free to use, reuse, update and improve them in anyway you see fit.
